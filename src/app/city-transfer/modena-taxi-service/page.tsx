...
export default function ModenaTaxiServicePage() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">Professional Taxi Service in Modena</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Reliable Transportation in Modena</h2>
        <p>Experience the best taxi and private transfer services in Modena. Whether you are traveling for business or leisure, our professional drivers ensure a comfortable and timely journey.</p>
        <ul className="list-disc ml-6 mt-4">
          <li>City center transfers</li>
          <li>Hotel pickups and drop-offs</li>
          <li>Sightseeing tours in Modena</li>
          <li>Fix-rate long distance transfers</li>
        </ul>
      </section>

      <section className="mb-8 p-6 bg-blue-50 border border-blue-100 rounded-xl">
        <h2 className="text-2xl font-semibold mb-4 text-blue-900">Why Choose Our Modena Taxi?</h2>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold">Can I book a taxi in Modena in advance?</h3>
          ...
          <div>
            ...
            <p>All our drivers in Modena are fully licensed, insured, and professional.</p>
          </div>
        </div>
      </section>
