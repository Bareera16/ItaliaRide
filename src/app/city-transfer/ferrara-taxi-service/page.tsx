...
export default function FerraraTaxiServicePage() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">Professional Taxi Service in Ferrara</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Reliable Transportation in Ferrara</h2>
        <p>Experience the best taxi and private transfer services in Ferrara. Whether you are traveling for business or leisure, our professional drivers ensure a comfortable and timely journey.</p>
        <ul className="list-disc ml-6 mt-4">
          <li>City center transfers</li>
          <li>Hotel pickups and drop-offs</li>
          <li>Sightseeing tours in Ferrara</li>
          <li>Fix-rate long distance transfers</li>
        </ul>
      </section>

      <section className="mb-8 p-6 bg-blue-50 border border-blue-100 rounded-xl">
        <h2 className="text-2xl font-semibold mb-4 text-blue-900">Why Choose Our Ferrara Taxi?</h2>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold">Can I book a taxi in Ferrara in advance?</h3>
          ...
          <div>
            ...
            <p>All our drivers in Ferrara are fully licensed, insured, and professional.</p>
          </div>
        </div>
      </section>
