...
export default function CityTransfersPage() {
    const cities = [
        { name: "Rome", link: "/city-transfer/rome-taxi-service" },
        { name: "Milan", link: "/city-transfer/milan-taxi-service" },
        { name: "Venice", link: "/city-transfer/venice-taxi-service" },
        { name: "Florence", link: "/city-transfer/florence-taxi-service" },
        { name: "Naples", link: "/city-transfer/naples-taxi-service" },
        { name: "Amalfi", link: "/city-transfer/amalfi-taxi-service" },
        { name: "Portofino", link: "/city-transfer/portofino-taxi-service" },
        { name: "Lake Como", link: "/city-transfer/como-taxi-service" }
    ];
