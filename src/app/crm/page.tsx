        ...
        <div className="flex min-h-screen bg-[#F8FAFC]">
            ...
            <aside className="w-80 bg-[#0F1C2E] text-white flex flex-col fixed h-full z-50">
                ...
                <nav className="flex-1 p-6 space-y-2">
                    ...
                    <button
                        className="w-full flex items-center gap-4 px-4 py-4 rounded-2xl bg-gold/10 text-gold border border-gold/20 shadow-lg shadow-gold/5 text-left"
                    >
                ...
                <div className="p-8 border-t border-white/5">
                    <div className="bg-white/5 rounded-2xl p-4 mb-6 flex items-center gap-3">
                        ...
                        <div className="overflow-hidden">
                            ...
                            <p className="text-[9px] text-gold uppercase font-bold tracking-widest opacity-50 uppercase">Administrator</p>
                        </div>
                    </div>
                    <button
                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="bg-navy text-white text-[9px] font-bold uppercase tracking-[0.3em]">
                                            <th className="px-10 py-6 uppercase">Customer Identity</th>
                                            <th className="px-10 py-6 uppercase">Route Logistics</th>
                                            <th className="px-10 py-6 uppercase">Schedule</th>
                                            <th className="px-10 py-6 text-center uppercase">Validation</th>
                                            <th className="px-10 py-6 text-right uppercase">Management</th>
                                        </tr>
                                    </thead>
