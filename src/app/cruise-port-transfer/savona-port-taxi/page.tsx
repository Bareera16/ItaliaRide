...
export default function SavonaPortTransferPage() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">Private Transfer to Savona Port</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Seamless Port Transfers</h2>
        <p>Reliable and professional taxi services between Savona Port and Savona city center, hotels, or airports. Ensure a stress-free start or end to your cruise with our meet and greet service.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-bold">Where will my driver meet me at Savona Port?</h3>
          ...
          <div>
            ...
            <p>Yes, we provide direct transfers from Savona Port to all major airports in Italy.</p>
          </div>
        </div>
      </section>
