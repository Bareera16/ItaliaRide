...
export default function RiminiBeachBeachPage() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">Taxi & Transfer to Rimini Beach</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Summer Transfers to Rimini Beach</h2>
        <p>Enjoy the sun and sea at Rimini Beach in Rimini without the hassle of parking or public transport. We provide reliable private transfers directly to the most beautiful beaches in Italy.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>Whether you're visiting for a day trip or an extended holiday, our Rimini taxi service ensures you reach Rimini Beach comfortably and on time.</p>
      </section>
