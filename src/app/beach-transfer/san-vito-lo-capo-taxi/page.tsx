...
export default function SanVitoloCapoBeachPage() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">Taxi & Transfer to San Vito lo Capo</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Summer Transfers to San Vito lo Capo</h2>
        <p>Enjoy the sun and sea at San Vito lo Capo in San Vito lo Capo without the hassle of parking or public transport. We provide reliable private transfers directly to the most beautiful beaches in Italy.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>Whether you're visiting for a day trip or an extended holiday, our San Vito lo Capo taxi service ensures you reach San Vito lo Capo comfortably and on time.</p>
      </section>
