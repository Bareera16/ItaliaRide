            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-6">
                        ...
                        <span className="text-white/80 text-sm font-bold uppercase tracking-widest ml-2">Trusted by 10,000+ travelers</span>
                    </div>
                </div>
                        ...
                        >
                            <div className="flex flex-col h-full w-full">
                                ...
                                <div className="mt-auto pt-6 border-t border-white/5 flex justify-between items-center text-[10px] font-bold uppercase tracking-wider">
                                    <span className="text-gold/40">Verified Review</span>
