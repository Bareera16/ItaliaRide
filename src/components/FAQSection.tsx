        ...
        <section className="py-24 bg-navy relative overflow-hidden font-inter">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-gold text-sm font-bold uppercase tracking-[0.4em] mb-4">Common Questions</h2>
                    <h3 className="text-4xl md:text-5xl font-bold text-white">Travel Frequently Asked Questions</h3>
                    ...
                    {faqs.map((faq, index) => (
                        ...
                        >
                            <div className="w-full">
                                <h4 className="text-xl font-bold text-white mb-4 group-hover:text-gold transition-colors">{faq.q}</h4>
